...
<section id="timeline">
  <section className="eol">
    ...
    <h4 className="minor">December 20th, 2020</h4>
  </section>
  <section className="active">
    <h3>Active development</h3>
    <h4 className="minor">March 4th, 2020 to July 25th, 2020</h4>
  </section>
  <section className="released">
    <h3>Released</h3>
    <h4 className="minor">March 4th, 2020</h4>
  </section>
  <section className="progress">
    <h3>Started development</h3>
    <h4 className="minor">Feburary 18th, 2020</h4>
  </section>
  <section className="progress">
