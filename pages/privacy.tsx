  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <p>
            I do not collect any personally identifiable information (PII). I utilise
            the "Accept-Language" to provide a more personalised version of the website.
        </p>
        <h3>Why is this data collected?</h3>
        <p>
            Using your Accept-Language header, I can display the website in a language
            that you might be able to understand. If you're browser doesn't report either
            French or Japanese, then it defaults to English.
        </p>
        ...
        <p>            
            Governments or law enforcement may request data from Vercel, to which
        ...
        <p>
            In the event of a data breach at Vercel, I cannot do anything to notify
            users as I do not collect identifiable data. I will leave a banner on the
            website to still spread awareness of such, however.
        </p>
